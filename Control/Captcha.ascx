...
<table border="0" cellpadding="0" cellspacing="5" style="<% =style %>; z-index: 100; left: 10px; top: 15px;">
    <tr>
    ...
    <tr>
        <td style="font-size: 10pt; height: 16px">
            <asp:Button ID="btnCSubmit" runat="server"
                Text="Submit" OnClick="btnSubmit_Click"  CssClass="btn btn-primary"/>
        </td>
    </tr>
</table>
