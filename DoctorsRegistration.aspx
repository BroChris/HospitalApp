<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DoctorsRegistration.aspx.cs" Inherits="DoctorsRegistration" %>
<%@ Register TagName="Captcha" TagPrefix="Controls" Src="~/Control/Captcha.ascx" %>
<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
 <head runat="server">
    <title>Doctors | Doctors Registration</title>
    <meta charset="utf-8"/>
                 ...
                 <br />
                  <div style="border-style: solid; height: 250px; width:220px" > 
                   ...
                   <br />
                    ...
                    <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-primary" >Upload Picture</asp:LinkButton>
             ...
             <div class="row">
              <div class="col-md-2"></div>
               ...
               <div class="form-group">
                   <br />
                      <h2 class="page-header" style="color:orange">Doctors Registration</h2>
                        ...
                        <asp:TextBox ID="txtSpecialty" runat="server" class="form-control" required="requied"></asp:TextBox>                 
                        
                        <asp:Label ID="lblNextofKin" runat="server" Text="Name of Next of Kin"></asp:Label>
